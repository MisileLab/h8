...
def tree_map(fn: Callable, tree: Any, *rest: Any, is_leaf: Optional[Callable] = ...) -> Any:
...
def tree_map_with_path(fn: Callable, tree: Any, *rest: Any, is_leaf: Optional[Callable] = ..., path: Optional[Any] = ...) -> Any:
...
def tree_flatten(tree: Any, prefix: str = ..., is_leaf: Optional[Callable] = ..., destination: Optional[Union[List[Tuple[str, Any]], Dict[str, Any]]] = ...) -> Union[List[Tuple[str, Any]], Dict[str, Any]]:
...
def tree_merge(tree_a, tree_b, merge_fn=...): # -> dict[Any, Any] | list[Any] | tuple[Any, *tuple[Any, ...]] | tuple[Any, ...]:
