...
def cross_entropy(logits: mx.array, targets: mx.array, weights: Optional[mx.array] = ..., axis: int = ..., label_smoothing: float = ..., reduction: Reduction = ...) -> mx.array:
    """
...
def binary_cross_entropy(inputs: mx.array, targets: mx.array, weights: Optional[mx.array] = ..., with_logits: bool = ..., reduction: Reduction = ...) -> mx.array:
    """
...
def l1_loss(predictions: mx.array, targets: mx.array, reduction: Reduction = ...) -> mx.array:
    """
...
def mse_loss(predictions: mx.array, targets: mx.array, reduction: Reduction = ...) -> mx.array:
    """
...
def nll_loss(inputs: mx.array, targets: mx.array, axis: int = ..., reduction: Reduction = ...) -> mx.array:
    """
...
def gaussian_nll_loss(inputs: mx.array, targets: mx.array, vars: mx.array, full: bool = ..., eps: float = ..., reduction: Reduction = ...) -> mx.array:
    r"""
...
def kl_div_loss(inputs: mx.array, targets: mx.array, axis: int = ..., reduction: Reduction = ...) -> mx.array:
    """
...
def smooth_l1_loss(predictions: mx.array, targets: mx.array, beta: float = ..., reduction: Reduction = ...) -> mx.array:
    r"""
...
def triplet_loss(anchors: mx.array, positives: mx.array, negatives: mx.array, axis: int = ..., p: int = ..., margin: float = ..., eps: float = ..., reduction: Reduction = ...) -> mx.array:
    r"""
...
def hinge_loss(inputs: mx.array, targets: mx.array, reduction: Reduction = ...) -> mx.array:
    r"""
...
def huber_loss(inputs: mx.array, targets: mx.array, delta: float = ..., reduction: Reduction = ...) -> mx.array:
    r"""
...
def log_cosh_loss(inputs: mx.array, targets: mx.array, reduction: Reduction = ...) -> mx.array:
    r"""
...
def cosine_similarity_loss(x1: mx.array, x2: mx.array, axis: int = ..., eps: float = ..., reduction: Reduction = ...) -> mx.array:
    r"""
...
def margin_ranking_loss(inputs1: mx.array, inputs2: mx.array, targets: mx.array, margin: float = ..., reduction: Reduction = ...) -> mx.array:
    r"""
