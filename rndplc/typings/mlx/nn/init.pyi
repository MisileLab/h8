...
def normal(mean: float = ..., std: float = ..., dtype: mx.Dtype = ...) -> Callable[[mx.array], mx.array]:
...
def uniform(low: float = ..., high: float = ..., dtype: mx.Dtype = ...) -> Callable[[mx.array], mx.array]:
...
def he_normal(dtype: mx.Dtype = ...) -> Callable[[mx.array, Literal["fan_in", "fan_out"], float], mx.array]:
...
def he_uniform(dtype: mx.Dtype = ...) -> Callable[[mx.array, Literal["fan_in", "fan_out"], float], mx.array]:
...
def sparse(sparsity: float, mean: float = ..., std: float = ..., dtype: mx.Dtype = ...) -> Callable[[mx.array], mx.array]:
...
def orthogonal(gain: float = ..., dtype: mx.Dtype = ...) -> Callable[[mx.array], mx.array]:
