...
def upsample_nearest(x: mx.array, scale_factor: Tuple): # -> array:
    ...

def upsample_linear(x: mx.array, scale_factor: Tuple, align_corners: bool = ...): # -> int:
    ...

def upsample_cubic(x: mx.array, scale_factor: Tuple, align_corners: bool = ...): # -> int:
    ...
...
class Upsample(Module):
    ...
    """
    def __init__(self, scale_factor: Union[float, Tuple], mode: Literal["nearest", "linear", "cubic"] = ..., align_corners: bool = ...) -> None:
        ...
