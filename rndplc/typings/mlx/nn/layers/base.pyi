...
class Module(dict):
    ...
    def load_weights(self, file_or_weights: Union[str, List[Tuple[str, mx.array]]], strict: bool = ...) -> Module:
        """
    ...
    def filter_and_map(self, filter_fn: Callable[[Module, str, Any], bool], map_fn: Optional[Callable] = ..., is_leaf_fn: Optional[Callable[[Module, str, Any], bool]] = ...): # -> dict[Any, Any | dict[Any, Any | dict[Any, Any] | list[Any]] | dict[Any, Any] | list[Any]]:
    ...
    def parameters(self): # -> dict[Any, Any | dict[Any, Any | dict[Any, Any] | list[Any]] | dict[Any, Any] | list[Any]]:
        """Recursively return all the :class:`mlx.core.array` members of this Module
        as a dict of dicts and lists."""
        ...
    
    def trainable_parameters(self): # -> dict[Any, Any | dict[Any, Any | dict[Any, Any] | list[Any]] | dict[Any, Any] | list[Any]]:
        """Recursively return all the non frozen :class:`mlx.core.array` members of
        this Module as a dict of dicts and lists."""
        ...
    
    def children(self): # -> dict[Any, Any | dict[Any, Any | dict[Any, Any] | list[Any]] | dict[Any, Any] | list[Any]]:
        """Return the direct descendants of this Module instance."""
        ...
    
    def leaf_modules(self): # -> dict[Any, Any | dict[Any, Any | dict[Any, Any] | list[Any]] | dict[Any, Any] | list[Any]]:
    ...
    def apply(self, map_fn: Callable[[mx.array], mx.array], filter_fn: Optional[Callable[[Module, str, Any], bool]] = ...) -> Module:
    ...
    def freeze(self, *, recurse: bool = ..., keys: Optional[Union[str, List[str]]] = ..., strict: bool = ...) -> Module:
    ...
    def unfreeze(self, *, recurse: bool = ..., keys: Optional[Union[str, List[str]]] = ..., strict: bool = ...) -> Module:
    ...
    def set_dtype(self, dtype: mx.Dtype, predicate: Optional[Callable[[mx.Dtype], bool]] = ...): # -> None:
