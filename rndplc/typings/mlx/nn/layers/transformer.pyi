...
class MultiHeadAttention(Module):
    ...
    Args:
        ...
        bias (bool, optional): Whether or not to use a bias in the projections.
            Default: ``False``.
    """
    def __init__(self, dims: int, num_heads: int, query_input_dims: Optional[int] = ..., key_input_dims: Optional[int] = ..., value_input_dims: Optional[int] = ..., value_dims: Optional[int] = ..., value_output_dims: Optional[int] = ..., bias: bool = ...) -> None:
        ...
    
    def __call__(self, queries, keys, values, mask=...): # -> array:
        ...
    
    @staticmethod
    def create_additive_causal_mask(N: int, dtype: mx.Dtype = ...): # -> array:
        ...
    


class TransformerEncoderLayer(Module):
    def __init__(self, dims: int, num_heads: int, mlp_dims: Optional[int] = ..., dropout: float = ..., activation: Callable[[Any], Any] = ..., norm_first: bool = ...) -> None:
        ...
    
    def __call__(self, x, mask): # -> array:
        ...
    


class TransformerEncoder(Module):
    def __init__(self, num_layers: int, dims: int, num_heads: int, mlp_dims: Optional[int] = ..., dropout: float = ..., activation=..., norm_first: bool = ..., checkpoint: bool = ...) -> None:
        ...
...
class TransformerDecoderLayer(Module):
    ...
    def __call__(self, x, memory, x_mask, memory_mask): # -> array:
        ...
...
class Transformer(Module):
    ...
    Args:
        ...
        checkpoint (bool, optional): if ``True`` perform gradient checkpointing
            ...
            Default: ``False``.
    """
    def __init__(self, dims: int = ..., num_heads: int = ..., num_encoder_layers: int = ..., num_decoder_layers: int = ..., mlp_dims: Optional[int] = ..., dropout: float = ..., activation: Callable[[Any], Any] = ..., custom_encoder: Optional[Any] = ..., custom_decoder: Optional[Any] = ..., norm_first: bool = ..., checkpoint: bool = ...) -> None:
        ...
    
    def __call__(self, src, tgt, src_mask, tgt_mask, memory_mask): # -> array | Any:
        ...
