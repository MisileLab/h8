...
class RNN(Module):
    ...
    * ``D`` is the input's feature dimension
    ...
    """
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., nonlinearity: Optional[Callable] = ...) -> None:
        ...
    
    def __call__(self, x, hidden=...): # -> array:
        ...
...
class LSTM(Module):
    ...
    * ``D`` is the input's feature dimension
    ...
    def __call__(self, x, hidden=..., cell=...): # -> tuple[array, array]:
        ...
