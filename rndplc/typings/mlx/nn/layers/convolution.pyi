    ...
    * ``C`` is the number of input channels
    ...
    Args:
        ...
        bias (bool, optional): If ``True`` add a learnable bias to the
            output. Default: ``True``
    """
    def __init__(self, in_channels: int, out_channels: int, kernel_size: Union[int, tuple], stride: Union[int, tuple] = ..., padding: Union[int, tuple] = ..., dilation: Union[int, tuple] = ..., groups: int = ..., bias: bool = ...) -> None:
        ...
    ...
    * ``C`` is the number of input channels
    ...
    Args:
        ...
        bias (bool, optional): If ``True`` add a learnable bias to the
            output. Default: ``True``
    """
    def __init__(self, in_channels: int, out_channels: int, kernel_size: Union[int, tuple], stride: Union[int, tuple] = ..., padding: Union[int, tuple] = ..., dilation: Union[int, tuple] = ..., bias: bool = ...) -> None:
        ...
