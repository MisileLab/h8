...
class RoPE(Module):
    ...
    """
    def __init__(self, dims: int, traditional: bool = ..., base: float = ..., scale: float = ...) -> None:
        ...
    
    def __call__(self, x, offset: int = ...): # -> array:
        ...
...
class SinusoidalPositionalEncoding(Module):
    ...
    """
    def __init__(self, dims: int, min_freq: float = ..., max_freq: float = ..., scale: Optional[float] = ..., cos_first: bool = ..., full_turns: bool = ...) -> None:
        ...
...
class ALiBi(Module):
    ...
    _alibi_mask = ...
    @classmethod
    def create_alibi_matrix(cls, q_sequence_length: int, k_sequence_length: int, num_heads: int, offset: int, dtype=...): # -> array | None:
        ...
    
    @staticmethod
    def create_alibi_slope(num_heads): # -> array:
        ...
    
    def __call__(self, attention_scores, offset=..., mask=...):
        ...
