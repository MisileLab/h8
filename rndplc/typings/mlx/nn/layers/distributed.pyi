...
@lru_cache
def sum_gradients(group): # -> Callable[..., Any] | Callable[..., array]:
    ...

def shard_inplace(module: Module, sharding: Union[str, Callable], *, segments: Union[int, list] = ..., group: Optional[mx.distributed.Group] = ...): # -> None:
...
def shard_linear(module: Module, sharding: str, *, segments: Union[int, list] = ..., group: Optional[mx.distributed.Group] = ...): # -> AllToShardedLinear | QuantizedAllToShardedLinear | QuantizedShardedToAllLinear | ShardedToAllLinear:
...
class AllToShardedLinear(Module):
    ...
    Args:
        ...
        group (mx.distributed.Group, optional): The sharding will happen across
            ...
            ``None``.
    """
    def __init__(self, input_dims: int, output_dims: int, bias: bool = ..., group: Optional[mx.distributed.Group] = ...) -> None:
        ...
    ...
    @classmethod
    def from_linear(cls, linear_layer: Module, *, segments: Union[int, list] = ..., group: Optional[mx.distributed.Group] = ...): # -> Self:
        ...
...
class QuantizedAllToShardedLinear(Module):
    ...
    Args:
        ...
        group (mx.distributed.Group, optional): The sharding will happen across
            ...
            ``None``.
    """
    def __init__(self, input_dims: int, output_dims: int, bias: bool = ..., group_size: int = ..., bits: int = ..., group: Optional[mx.distributed.Group] = ...) -> None:
        ...
    ...
    @classmethod
    def from_quantized_linear(cls, quantized_linear_layer: Module, *, segments: Union[int, list] = ..., group: Optional[mx.distributed.Group] = ...): # -> Self:
        ...
