...
def quantize(model: Module, group_size: int = ..., bits: int = ..., *, mode: str = ..., class_predicate: Optional[Callable[[str, Module], Union[bool, dict]]] = ...): # -> None:
...
class QuantizedEmbedding(Module):
    ...
    Args:
        ...
        mode (str): The quantization method to use (see
           :func:`mlx.core.quantize`). Default: ``"affine"``.
    """
    def __init__(self, num_embeddings: int, dims: int, group_size: int = ..., bits: int = ..., mode: str = ...) -> None:
        ...
    ...
    @classmethod
    def from_embedding(cls, embedding_layer: Module, group_size: int = ..., bits: int = ..., mode: str = ...): # -> Self:
...
class QuantizedLinear(Module):
    ...
    Args:
        ...
        mode (str): The quantization method to use (see
           :func:`mlx.core.quantize`). Default: ``"affine"``.
    """
    def __init__(self, input_dims: int, output_dims: int, bias: bool = ..., group_size: int = ..., bits: int = ..., mode: str = ...) -> None:
        ...
    ...
    @classmethod
    def from_linear(cls, linear_layer: Module, group_size: int = ..., bits: int = ..., mode: str = ...): # -> Self:
