...
class Linear(Module):
    ...
    def to_quantized(self, group_size: int = ..., bits: int = ..., mode: str = ...): # -> QuantizedLinear:
...
class Bilinear(Module):
    ...
    Args:
        ...
        bias (bool, optional): If set to ``False`` then the layer will
          not use a bias. Default is ``True``.
    """
    def __init__(self, input1_dims: int, input2_dims: int, output_dims: int, bias: bool = ...) -> None:
        ...
