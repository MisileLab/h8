...
@partial(mx.compile, shapeless=True)
def leaky_relu(x, negative_slope=...): # -> array:
...
@partial(mx.compile, shapeless=True)
def softshrink(x, lambd: float = ...): # -> array:
...
@partial(mx.compile, shapeless=True)
def step(x: mx.array, threshold: float = ...): # -> array:
...
@partial(mx.compile, shapeless=True)
def hard_tanh(x, min_val=..., max_val=...): # -> array:
