...
class _Pool(Module):
    def __init__(self, pooling_function, kernel_size, stride, padding, padding_value) -> None:
        ...
...
class _Pool1d(_Pool):
    def __init__(self, pooling_function, padding_value, kernel_size: Union[int, Tuple[int]], stride: Optional[Union[int, Tuple[int]]] = ..., padding: Union[int, Tuple[int]] = ...) -> None:
        ...
    


class _Pool2d(_Pool):
    def __init__(self, pooling_function, padding_value, kernel_size: Union[int, Tuple[int, int]], stride: Optional[Union[int, Tuple[int, int]]] = ..., padding: Optional[Union[int, Tuple[int, int]]] = ...) -> None:
        ...
    


class _Pool3d(_Pool):
    def __init__(self, pooling_function, padding_value, kernel_size: Union[int, Tuple[int, int, int]], stride: Optional[Union[int, Tuple[int, int, int]]] = ..., padding: Optional[Union[int, Tuple[int, int, int]]] = ...) -> None:
        ...
...
class MaxPool1d(_Pool1d):
    ...
    Examples:
        ...
        >>> pool(x)
    """
    def __init__(self, kernel_size: Union[int, Tuple[int]], stride: Optional[Union[int, Tuple[int]]] = ..., padding: Union[int, Tuple[int]] = ...) -> None:
        ...
...
class MaxPool2d(_Pool2d):
    ...
    * a ``tuple`` of two ``int`` s -- in which case, the first ``int`` is
    ...
    Examples:
        ...
        >>> pool(x)
    """
    def __init__(self, kernel_size: Union[int, Tuple[int, int]], stride: Optional[Union[int, Tuple[int, int]]] = ..., padding: Optional[Union[int, Tuple[int, int]]] = ...) -> None:
        ...
...
class MaxPool3d(_Pool3d):
    ...
    * a ``tuple`` of three ``int`` s -- in which case, the first ``int`` is used
    ...
    Examples:
        ...
        >>> pool(x)
    """
    def __init__(self, kernel_size: Union[int, Tuple[int, int, int]], stride: Optional[Union[int, Tuple[int, int, int]]] = ..., padding: Optional[Union[int, Tuple[int, int, int]]] = ...) -> None:
        ...
