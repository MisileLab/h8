...
def value_and_grad(model: Module, fn: Callable): # -> _Wrapped[..., Any, ..., tuple[Any, Any]]:
...
def checkpoint(module: Module, fn: Optional[Callable] = ...): # -> _Wrapped[..., Any, ..., Any]:
...
def average_gradients(gradients: Any, group: Optional[mx.distributed.Group] = ..., all_reduce_size: int = ..., communication_type: Optional[mx.Dtype] = ..., communication_stream: Optional[mx.Stream] = ...): # -> Any:
