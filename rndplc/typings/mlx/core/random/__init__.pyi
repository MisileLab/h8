...
import mlx.core
from mlx.core import Device, Dtype, Stream, array, float32, int32, scalar
from typing import Optional, Sequence, Union

def bernoulli(p: Union[scalar, array] = ..., shape: Optional[Sequence[int]] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def categorical(logits: array, axis: int = ..., shape: Optional[Sequence[int]] = ..., num_samples: Optional[int] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def gumbel(shape: Sequence[int] = ..., dtype: Optional[Dtype] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def laplace(shape: Sequence[int] = ..., dtype: Optional[Dtype] = ..., loc: float = ..., scale: float = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def multivariate_normal(mean: array, cov: array, shape: Sequence[int] = ..., dtype: Optional[Dtype] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def normal(shape: Sequence[int] = ..., dtype: Optional[Dtype] = ..., loc: Union[scalar, array, None] = ..., scale: Union[scalar, array, None] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    r"""
...
def permutation(x: Union[int, array], axis: int = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def randint(low: Union[scalar, array], high: Union[scalar, array], shape: Sequence[int] = ..., dtype: Optional[Dtype] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def split(key: array, num: int = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
state: list = ...
def truncated_normal(lower: Union[scalar, array], upper: Union[scalar, array], shape: Optional[Sequence[int]] = ..., dtype: Optional[Dtype] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def uniform(low: Union[scalar, array] = ..., high: Union[scalar, array] = ..., shape: Sequence[int] = ..., dtype: Optional[Dtype] = ..., key: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
