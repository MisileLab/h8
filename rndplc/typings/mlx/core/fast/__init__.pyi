...
def cuda_kernel(name: str, input_names: Sequence[str], output_names: Sequence[str], source: str, header: str = ..., ensure_row_contiguous: bool = ..., shared_memory: int = ...) -> object:
    r"""
...
def layer_norm(x: array, weight: Optional[array], bias: Optional[array], eps: float, *, stream: Union[None, Stream, Device] = ...) -> array:
    """
    Layer normalization.
...
def metal_kernel(name: str, input_names: Sequence[str], output_names: Sequence[str], source: str, header: str = ..., ensure_row_contiguous: bool = ..., atomic_outputs: bool = ...) -> object:
    r"""
...
def precompiled_cuda_kernel(*, name: str, compiled_source: bytes, inputs: Sequence[bool | int | float | mlx.core.array | Annotated[ArrayLike, dict(order='C', device='cpu', writable=False)] | complex | mlx.core.ArrayLike], output_shapes: Sequence[tuple[int, ...]], output_dtypes: Sequence[mlx.core.Dtype], scalars: Sequence[object], grid: tuple[int, int, int], threadgroup: tuple[int, int, int], shared_memory: int = ..., init_value: float | None = ..., ensure_row_contiguous: bool = ..., stream: mlx.core.Stream | mlx.core.Device | None = ...) -> list[mlx.core.array]:
    """
...
def rms_norm(x: array, weight: Optional[array], eps: float, *, stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def rope(a: array, dims: int, *, traditional: bool, base: Optional[float], scale: float, offset: Union[int, array], freqs: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def scaled_dot_product_attention(q: array, k: array, v: array, *, scale: float, mask: Union[None, str, array] = ..., sinks: Optional[array] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
