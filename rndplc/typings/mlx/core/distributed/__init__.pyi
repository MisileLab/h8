...
def all_gather(x: array, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def all_max(x: array, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
    All reduce max.
...
def all_min(x: array, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
    All reduce min.
...
def all_sum(x: array, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
    All reduce sum.
...
def recv(shape: Sequence[int], dtype: Dtype, src: int, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def recv_like(x: array, src: int, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def send(x: array, dst: int, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def sum_scatter(x: array, *, group: Optional[Group] = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
