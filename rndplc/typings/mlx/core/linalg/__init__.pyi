...
def cholesky(a: array, upper: bool = ..., *, stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def cholesky_inv(L: array, upper: bool = ..., *, stream: Union[None, Stream, Device] = ...) -> array:
    r"""
...
def cross(a: array, b: array, axis: int = ..., *, stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def eig(a: array, *, stream: Union[None, Stream, Device] = ...) -> Tuple[array, array]:
    """
...
def eigh(a: array, UPLO: str = ..., *, stream: Union[None, Stream, Device] = ...) -> Tuple[array, array]:
    """
...
def eigvals(a: mlx.core.array, *, stream: mlx.core.Stream | mlx.core.Device | None = ...) -> mlx.core.array:
    """
...
def eigvalsh(a: mlx.core.array, UPLO: str = ..., *, stream: mlx.core.Stream | mlx.core.Device | None = ...) -> mlx.core.array:
    """
...
def inv(a: array, *, stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def lu(a: array, *, stream: Union[None, Stream, Device] = ...) -> Tuple[array, array, array]:
    """
...
def lu_factor(a: array, *, stream: Union[None, Stream, Device] = ...) -> Tuple[array, array]:
    """
...
def norm(a: array, /, ord: Union[None, int, float, str] = ..., axis: Union[None, int, list[int]] = ..., keepdims: bool = ..., *, stream: Union[None, Stream, Device] = ...) -> array:
    r"""
...
def pinv(a: array, *, stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def qr(a: array, *, stream: Union[None, Stream, Device] = ...) -> Tuple[array, array]:
    """
...
def solve(a: array, b: array, *, stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def solve_triangular(a: array, b: array, *, upper: bool = ..., stream: Union[None, Stream, Device] = ...) -> array:
    """
...
def svd(a: array, compute_uv: bool = ..., *, stream: Union[None, Stream, Device] = ...) -> Tuple[array, array, array]:
    """
...
def tri_inv(a: array, upper: bool = ..., *, stream: Union[None, Stream, Device] = ...) -> array:
    """
